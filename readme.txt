...
the tv show Bob's Burgers had singing in the majority of the episodes, which I believed to be untrue. 

I used the beautifulSoup library to scrape and parse the scripts for each episode into text files where I then scanned for any line with a musical note next to the text, signifying that a song or even a 1-2 line jingle is said. 
